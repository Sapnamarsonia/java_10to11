...
public class EmailSendingServlet2 extends HttpServlet
{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException 
	{
		...
		String subject = "Welcome to TOYZWIN E-commerce Shopping Project";
		...
		String content = "Welcome to TOYZWIN Website Here you can purchase your Valuable Products Your Verification OTP is "+n1+n2+n3+n4;
