...
public static void main(String[] args)  // main method
	{
		new Assessment(); // calling constructor
	}
	...
	public void insertdata()  // insert operation
	{
				...
				try 
				{
					...
					String sql = "insert into details (ID,Firstname,Lastname,Email,Mobile) values (null,'"+Firstname+"','"+Lastname+"','"+Email+"','"+Mobile+"')";
	...
	{          
				...
				try 
				{
					...
					String sql = "update details set Firstname='"+Firstname+"',Lastname='"+Lastname+"',Email='"+Email+"',Mobile='"+Mobile+"' where id='"+id1+"'";
	...
	public void deletedata()  // delete method operation 
	{
			...
			try 
			{
				...
				// delete sql query 
				String query = "delete from details where ID ='"+id2+"'";
